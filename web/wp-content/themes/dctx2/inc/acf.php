...
function dctx_get_theme_colors() {
	return array(
		esc_html__( 'Tango', 'dctx' )           => '#ea641d',
		esc_html__( 'corn', 'dctx' )            => '#e8ca04',
		esc_html__( 'Limeaid', 'dctx' )         => '#71b406',
		esc_html__( 'Electric Violet', 'dctx' ) => '#7f08ff',
		esc_html__( 'Jacksons Purple', 'dctx' ) => '#311B92',
