...
( function( window, $, app ) {
	...
	app.cache = function() {
		app.$c = {
			window: $( window ),
			headerButtonSelect: $( '#customize-control-dctx_header_button select' ),
			headerLinkButton: $( '#customize-control-dctx_header_button_url' ),
			headerLinkText: $( '#customize-control-dctx_header_button_text' )
		};
	};
